  ...
  return (
    <>
      <PageBanner
        ...
        title="A stronger research page with a full-width institutional feel"
        text="This section presents Liuli Society as a serious nonprofit platform for wellness education, exploratory development, and future collaboration in innovation-oriented environments."
        image={researchImg}
      ...
      <Section
        ...
        title="A calm, credible, and accessible research narrative"
        text="The tone is designed to be academic-light, mission-driven, and understandable to non-technical audiences."
      >
